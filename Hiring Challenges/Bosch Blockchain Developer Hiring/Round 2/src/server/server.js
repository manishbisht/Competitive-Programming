...
app.get("/registeredProperties", (req, res)  => {
    PropertyRegistrationApp.methods.getRegisteredProperties().call().then((response) => {
...
app.post('/registerProperty', (req, res) => {
    ...
    PropertyRegistrationApp.methods.registerProperty(ownerName, ownerId, passCode, propertyType, propertyAddress, propertyDimensions).send({
            from: ownerId,
            gas: 4712388,
...
app.post('/sellProperty', (req, res) => {
    ...
    PropertyRegistrationApp.methods.setPropertyPrice(propertyId, price).send({
            from: ownerId,
            gas: 4712388,
            gasPrice: 100000000000
        }
...
app.post('/buyProperty', (req, res) => {
    ...
    PropertyRegistrationApp.methods.transferProperty(propertyId, newOwnerName).send({
            from: newOwnerId,
            value: price,
            gas: 4712388,
            gasPrice: 100000000000
